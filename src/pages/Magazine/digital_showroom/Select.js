...
import CreateRequestSample from "components/magazine/digital_showroom/CreateRequestSample";
...
const ContensWrap = styled.div`
  ...
  margin-left: -20px;
    @media (min-width: 1920px) {
        width: ${(props) => (props.active ? "1500px" : "1500px")};    
    }
    @media (min-width: 1440px) and (max-width: 1919px) {          
        width: ${(props) => (props.active ? "1250px" : "960px")};
    }
    @media (min-width: 10px) and (max-width: 1439px) {
        width: ${(props) => (props.active ? "900px" : "650px")};    
    } 
`;
