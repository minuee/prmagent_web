...
export default function LookDetail({ match }) {
  ...
  const getShareUrl = useMutation(
    ...
    {
      onSuccess: (data) => {
        setShareUrl(domain.replace("#/","") + "share-lookbook-detail/" + data.share_uuid+"/"+showroomNo);
      ...
      <Container active={isdrawer}>
        ...
        <HeadWrap active={isdrawer}>
          ...
          <RightWrap isShow={isShow}>
            ...
            <Btn2>
              <KakaoShareButton 
                shareUrl={domain + "share-lookbook-detail/" + data.lookbookData.share_uuid + "/"+showroomNo}
        ...
        <ContentsWrap active={isdrawer} dataLength={utils.isEmpty(data.sample_list)?0:data.sample_list.length}>
          <BtnLeftWrap active={isdrawer}>
            { ( data.prev_showroom_no !== null && data.prev_showroom_no !== undefined ) && (
          ...
          {data.sample_list.map((v, idx) => (
           ...
           { (data.next_showroom_no !== null && data.next_showroom_no !== undefined ) && (
