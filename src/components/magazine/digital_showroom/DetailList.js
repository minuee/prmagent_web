    ...
    <>
      <MainContainer active={isdrawer}>        
        ...
        <DetailWrap active={isdrawer}>
          ...
          <div>
            {/* <SubTitle>
              <TitleName>이용상태</TitleName>
              { 
                data.now_req_status_nm === '대여중' ?
                <TitleRedValue status={data.now_req_status_nm}>
                  {data.now_req_status_nm}
                </TitleRedValue>
                :
                <TitleValue status={data.now_req_status_nm}>
                  {data.now_req_status_nm}
                </TitleValue>
              }
            </SubTitle>
            {
              ...
              <SubTitle>
                <TitleName>{" "}</TitleName>
                <TitleValue>
                  {utils.dateToDate(data.duty_recpt_dt)} ~ {utils.dateToDate(data.return_prearnge_dt)}
                </TitleValue>
              </SubTitle>
            } */}
            <StyleDividerSub />
            ...
            <StyleDividerSub />
            <SubTitle2>
              <TextFieldTitle>국문 캡션</TextFieldTitle>
              <StyledTextField
                multiline
                placeholder="-"
                rows={4}
                ...
                disabled={true}
              />
              <TextFieldTitle>영문 캡션</TextFieldTitle>
              <StyledTextField
                multiline
                placeholder="-"
                rows={4}
...
const ImgWrap = styled.div`
  ...
  @media (min-width: 10px) and (max-width: 1439px) {  
    width: ${(props) => (props.active ? "350px" : "400px")};
    margin-right: ${(props) => (props.active ? "50px" : "0px")};
    justify-content: center;  
    align-items:center;
  } 
`;
...
const DetailWrap = styled.div`
  ...
  @media (min-width: 1440px) and (max-width: 1919px) {              
    width:   ${(props) => (props.active ? "644px" : "444px")};  
  }
  @media (min-width: 10px) and (max-width: 1439px) {  
    width: 444px;
...
const TitleValue = styled.div`
  color: #555555;
`;
const TitleRedValue = styled.div`
  color: #ff0000;
`;
