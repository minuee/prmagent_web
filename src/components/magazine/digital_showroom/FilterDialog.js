...
export default function FindIdDialog({
  open,
  setOpen,
  filterData,
  setFilterData,
  ...
  useEffect(() => {
    setSelectGender(filterData.gender_list);
    setSelectCategory(filterData.category_list);
    setSelectMaterial(filterData.material_list);
    setSelectColor(filterData.color_list);
    setSelectSize(filterData.size_list);
    setStillLifeImg(
      filterData.still_life_img_yn === null
        ? "all"
