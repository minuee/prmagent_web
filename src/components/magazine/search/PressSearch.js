...
export default function PressSearch({ searchText, total, setTotal }) {
  ...
  const {
    ...
    ["main-search-mgzn", "press", searchText],
    getSearchList,
    {
                  ...
                  <ItemWrap active={isdrawer}>
                    {group.press.map((d) => (
                      <Item
                        ...
                        onClick={() =>
                          history.push(
                            `/magazine/press_release/detail/${d.brand_press_no}`
                          )
                        }
                        active={isdrawer}
                      >
                        ...
                        <TextWrap active={isdrawer}>
                          ...
                          <div className="brand">{d.brand_nm}</div>
                        </TextWrap>
                      </Item>
                    ))}
                  </ItemWrap>
