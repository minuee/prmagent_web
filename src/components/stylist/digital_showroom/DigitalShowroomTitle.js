...
export default function DigitalShowroom({
  ...
  const handleShowroomClick = () => {
    history.push("/stylist/digital_showroom");
  };
  ...
  return (
    <>
      {!selectBtn ? (
        <Container>
          <TitleTxt1>Digital</TitleTxt1>
          <TitleTxt2Wrap active={isdrawer}>
            <TitleTxt2SubWrap addTopPadding={false}>
              <TitleTxt2>Showroom</TitleTxt2>
            ...
            <TitleTxt2SubWrap addTopPadding={true}>
              ...
              <OptBtn width="106px" onClick={handleSelectBtn}>
                <OptTxtWrap>Select</OptTxtWrap>
              </OptBtn>
            </TitleTxt2SubWrap>
          </TitleTxt2Wrap>
        </Container>
        ...
        <Container>
          ...
          <TitleTxt2Wrap active={isdrawer}>
            ...
            <TitleTxt2SubWrap addTopPadding={true}>
              ...
              <OptBtn width="146px" onClick={handleShowroomClick}>
                <OptBtnImgWrap>
                  <SyncIcon />
                </OptBtnImgWrap>
                <OptTxtWrap>Showroom</OptTxtWrap>
              </OptBtn>
              {/* <OptBtn width="120px" onClick={handleSelectBtn}>
                <OptTxtWrap>Select</OptTxtWrap>
              </OptBtn> */}
              <AddBtn
                onClick={handleSelectBtn}
                style={{ marginLeft: "12px", minWidth: "106px" }}
              >
                <div>Select</div>
              </AddBtn>
            </TitleTxt2SubWrap>
