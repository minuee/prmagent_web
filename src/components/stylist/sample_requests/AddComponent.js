...
import SelectInputAddress from "components/stylist/sample_requests/selectInputAddress";
...
import ModelTextInput from "components/stylist/sample_requests/ModelTextInput";
...
export default function AddComponent({data,brandId,handleCancel,handleSubmit,handleTemporarySave,}) {
    ...
    const [startTime, setStartTime] = useState({hour: "",ampm: "",});
    const [endTime, setEndTime] = useState({hour: "",ampm: "",});
    const [year, setYear] = useState(dayjs().format("YYYY"));
    const [today, setToday] = useState(moment());
    const [address, setAddress] = useState(false);
    const [celebCheck, setCelebCheck] = useState(false);
    const [celebList, setCelebList] = useState([]);
    const [celebCnt, setCelebCnt] = useState(1);
    const [modelCheck, setModelCheck] = useState(false);
    const [modelList, setModelList] = useState([]);
    const [modelCnt, setModelCnt] = useState(1);
    ...
    const handleChangeStartTime = (ampm, newTime) => {
        setStartTime({hour: newTime,ampm: ampm,});
    };

    const handleChangeEndTime = (ampm, newTime) => {
        setEndTime({hour: newTime,ampm: ampm,});
    };
    ...
    const handleShowroominfo = (data) => {
        if ( showroomList.length === 1 ) {
            ...
            setShowroomList(
                showroomList.some((d) => d.showroom_no === data) ? showroomList.filter((v) => v.showroom_no !== data) : { ...showroomList }
            );
        }
    };
    ...
    const handleSampleRequest = () => {
        ...
        let requestBody = {
            ...
            model_list: !modelCheck ? [] : modelList,
            model_list_yn: modelCheck,
            celeb_list: !celebCheck ? [] : celebList,
    ...
    /* const shipping_dest_options = data.user.map((d) => ({
        value: d.dlvy_adres_no,
        label: d.dlvy_adres_nm + " " + d.adres_detail,
        nm: d.dlvy_adres_nm,
        detail: d.adres_detail,
                    ...
                    <ImgWrap isData={showroomList.length > 0 ? true :false}>
                        {
                            showroomList.map((d) => (
                                <ImgDiv key={d.showroom_no}>
                                    ...
                                    <ImgCover><img src={ImgCheckIcon} alt="checked" /></ImgCover>
                    ...
                    <DetailWrap>
                        <Rows>
                            <Box>
                                ...
                                <InputWrap>
                                    <InputTitle>담당 기자/스타일리스트<Require>*</Require></InputTitle>
                                    ...
                                    <Box>
                                        ...
                                        <InputRead>
                                            ...
                                            ? 
                                                ""
                                            : 
                                            utils.phoneFormat(data.contact_info.find((v) => v.user_id === inputs.contact_user_id).phone_no)
                                            }
                                        </InputRead>
                                    </Box>
                                </InputWrap>
                        ...
                        <Rows>
                            ...
                            <InputWrap margin="10px">
                                <InputTitle>픽업일<Require>*</Require></InputTitle>
                                <DatePicker
                                    dt={pickupDt}
                                    setDt={setPickupDt}
                                    unavailDt={unavailDt}
                            ...
                            <InputWrap margin="10px">
                                <InputTitle>반납일<Require>*</Require></InputTitle>
                                <DatePicker
                                    dt={returningDt}
                        ...
                        <Rows>
                            <InputWrap margin="10px">
                                <InputTitle>촬영 시작 시간<Require>*</Require></InputTitle>
                                <TimePicker
                                    time={startTime}
                            ...
                            <InputWrap>
                                <InputTitle>촬영 종료 시간<Require>*</Require></InputTitle>
                                <TimePicker
                                    time={endTime}
                                    setTime={setEndTime}
                        ...
                        <Rows>
                            <InputWrap margin="20px">
                                ...
                                <AddressWrap>
                                    <AddressRead onClick={() => setAddress(true)}>{inputs.address}</AddressRead>
                                    <AddressBtn onClick={() => setAddress(true)}>주소검색</AddressBtn>
                                </AddressWrap>
                                <StyleTextField2
                                    variant="outlined"
                        ...
                        <Rows>
                            <InputWrap margin="20px">
                                <InputTitle>배송 관련 메모<Require>*</Require></InputTitle>
                                <StyleTextField3
                                    variant="outlined"
                        ...
                        <Rows>
                            <InputWrap margin="20px">
                                <InputTitle>촬영컨셉<Require>*</Require></InputTitle>
                                <StyleTextField2
                                    variant="outlined"
                        ...
                        <Rows>
                            <InputWrap margin="20px" width="100%">
                                <InputTitle>모델<Require>*</Require></InputTitle>
                                <ModelWrap>
                                    <CheckBoxWrap onClick={() => setCelebCheck(!celebCheck)}>
                                        <CheckBoxWrapDetail>
                                            <CheckBoxImg src={celebCheck ? CheckBoxOn : CheckBoxOff} alt="" />
                                            셀러브리티
                                        </CheckBoxWrapDetail>
                                    </CheckBoxWrap>
                                    <ModelInput>
                                ...
                                <ModelWrap>
                                    <CheckBoxWrap onClick={() => setModelCheck(!modelCheck)}>
                                        <CheckBoxWrapDetail>
                                            <CheckBoxImg src={modelCheck ? CheckBoxOn : CheckBoxOff} alt="" />
                                            패션 모델
                                        </CheckBoxWrapDetail>
                                    </CheckBoxWrap>
                                    <ModelInput>
                            ...
                            <InputWrap margin="20px" width="100%">
                                ...
                                <ModelWrap>
                                    <CheckBoxWrap2 onClick={() => handlePicalbmChk("own")}>
                                        <CheckBoxWrapDetail>
                                            <CheckBoxImg src={inputs.picalbm_chk === "own"? CheckBoxOn: CheckBoxOff} alt="" />
                                            자사유가
                                        </CheckBoxWrapDetail>
                                    </CheckBoxWrap2>
                                    <div>
                                ...
                                <ModelWrap>
                                    <CheckBoxWrap2 onClick={() => handlePicalbmChk("other")}>
                                        <CheckBoxWrapDetail>
                                            <CheckBoxImg src={inputs.picalbm_chk === "other"? CheckBoxOn: CheckBoxOff} alt=""/>
                                            타사유가
                                        </CheckBoxWrapDetail>
                                    </CheckBoxWrap2>
                                    <div>
                            ...
                            <InputWrap margin="20px" width="100%">
                                ...
                                <ModelWrap>
                                    <CheckBoxWrap2 onClick={() => setInputs({ ...inputs, loc_yn: !inputs.loc_yn })}>
                                        <CheckBoxWrapDetail>
                                            <CheckBoxImg src={inputs.loc_yn ? CheckBoxOn : CheckBoxOff} alt="" />
                                            로케촬영
                                        </CheckBoxWrapDetail>
                                    </CheckBoxWrap2>
                                    <div>
                        ...
                        {/* <Rows>
                            <InputWrap margin="20px" width="100%">
                                ...
                                <HopeBtnWrap>
                                    <Btn active={inputs.today_connect} onClick={() => setInputs({ ...inputs, today_connect: true })}
                                    >
                                        <StyleCheckIcon />Yes
                                    </Btn>
                                    <Btn active={!inputs.today_connect} onClick={() =>setInputs({ ...inputs, today_connect: false })}>
                                        <StyleCheckIcon />No
                                    </Btn>
                                </HopeBtnWrap>
                            </InputWrap>
                        ...
                        <Rows>
                            <InputWrap margin="20px">
                                <InputTitle>페이지 수<Require>*</Require></InputTitle>
                                <StyleTextField2
                                    variant="outlined"
...
const BtnWrap = styled.div`
    ...
    align-items: center;
    cursor: pointer;
    background-color: ${(props) => props.type === "cancel" ? "#ffffff" : "#000000"};
...
const Img = styled.img`
    width: 240px;
    height: 360px;
    border: solid 1px #dddddd; ${(props) => props.imgUrl !== null
    ?
    css`
