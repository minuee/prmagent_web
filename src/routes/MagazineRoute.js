...
import PickupDetailSinglePage from "pages/Magazine/new_pickup/DetailSinglePage";
import SendoutDetailSinglePage from "pages/Magazine/new_pickup/SendoutSinglePage";
    ...
    <RecoilRoot>
      ...
      <Switch>
        <Layout hasRightMargin={!pathname.includes("scheduler")}>
          ...
          <Route
            exact
            path="/magazine/pickup_single/:timestamp/:view"
            component={PickupDetailSinglePage}
          />
          <Route
            exact
            path="/magazine/sendout_single/:timestamp/:view"
            component={SendoutDetailSinglePage}
          />
          <Route
            exact
